...
let cream_tls_1_2_release_schema_minor_vsn  = 68
...
let host_create_params =
  [
    ...
    {param_type=Bool; param_name="ssl_legacy"; param_doc="Allow SSLv3 protocol and ciphersuites as used by older XenServers. This controls both incoming and outgoing connections."; param_release=tampa_release; param_default=Some (VBool true)};
  ]
