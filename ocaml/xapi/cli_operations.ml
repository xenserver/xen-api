...
let gen_cmds rpc session_id =
  ...
  (make_param_funs (Client.Pool_update.get_all) (Client.Pool_update.get_all_records_where) (Client.Pool_update.get_by_uuid) (pool_update_record) "update" [] ["uuid"; "name-label"; "name-description"; "installation-size"; "hosts"; "after-apply-guidance"] rpc session_id) @
